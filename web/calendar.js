...
const renderCalendar = () => {
  ...
  const months = [
    ...
    // document.querySelector('.content h2').innerHTML = months[date.getMonth()];
    document.querySelector('.date p').innerHTML =  new Date().toLocaleDateString('en-US', {weekday: 'long' }) + " | " + 
